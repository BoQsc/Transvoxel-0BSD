...
DOES_NOT_PROVE = [
    ...
    "It proves functional regular and transition behavior but still marks official class numbers, exact triangulation identity, reuse encoding, and bytes as NOT_PROVEN.",
