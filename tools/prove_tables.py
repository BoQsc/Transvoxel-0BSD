...
DOES_NOT_PROVE = [
    ...
    "It proves the published reference convention but still marks official 73-class numeric mapping and original transition topology equivalence as NOT_PROVEN.",
