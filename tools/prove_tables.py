...
PROVES = [
    ...
    "Committed M20 evidence proves the default preferred-polarity regular-cell replacement across all cases, regular neighbors, M4 boundaries, Zig C, and Godot loading.",
    "M21 evidence proves the default clean-room M4 transition export and public C/C++ consumer compatibility contract.",
    "M22 evidence locks the exact-compatibility claim boundary so functional replacement claims do not imply official table/encoding/byte identity.",
...
DOES_NOT_PROVE = [
    ...
    "It proves functional regular and transition behavior through the public API but still marks official class numbers, exact triangulation identity, reuse encoding, and bytes as NOT_PROVEN.",
