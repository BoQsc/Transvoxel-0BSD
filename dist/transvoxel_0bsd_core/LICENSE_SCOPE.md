...
## License choice is not an engineering-equivalence claim

Both licenses permit practical production use. MIT requires preserving its
copyright and permission notice; 0BSD removes that condition. Choosing 0BSD
does not make its independently generated topology identical to the MIT exact
path or give it the same production history.

Use `docs/CHOOSING_0BSD_OR_MIT.md` for the engineering tradeoff. License scope
and production confidence are separate decisions.
