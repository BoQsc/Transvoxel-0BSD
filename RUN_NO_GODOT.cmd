...
setlocal
cd /d "%~dp0"
echo Running Transvoxel 0BSD full proof without Godot...
echo.
where py.exe >nul 2>nul
if not errorlevel 1 (
    py -3 tools\run_everything.py --mode full --skip-godot
...
if not errorlevel 1 (
    python tools\run_everything.py --mode full --skip-godot
    set RESULT=%ERRORLEVEL%
    echo.
    echo Finished. Result code: %RESULT%
    echo See proof\ONE_CLICK_RESULT.txt and proof\SEND_TO_CHATGPT.zip
