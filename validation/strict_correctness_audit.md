...
- `internal_reference_convention_matrix`: **PASS_INTERNAL_CONVENTION_MATRIX**
- `edited_terrain_all_six_faces_scripted`: **NOT_PROVEN_OR_NOT_RUN**
...
This is an honesty gate. It strengthens generated-table audits while clearly marking official 73-class/reference/topology equivalence and exhaustive production corner-junction proof as not proven.
